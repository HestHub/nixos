...
"/run/current-system/sw/bin/aerospace list-workspaces --all --format '%{workspace}%{monitor-appkit-nsscreen-screens-id}' --json"
...
local function withWindows(f)
    ...
    local get_windows = "/run/current-system/sw/bin/aerospace list-windows --monitor all --format '%{workspace}%{app-name}%{window-id}' --json"
    local query_visible_workspaces =
    "/run/current-system/sw/bin/aerospace list-workspaces --visible --monitor all --format '%{workspace}%{monitor-appkit-nsscreen-screens-id}' --json"
    local get_focus_workspaces = "/run/current-system/sw/bin/aerospace list-workspaces --focused"
...
sbar.exec(query_workspaces, function(workspaces_and_monitors)
    for _, entry in ipairs(workspaces_and_monitors) do
        ...
        local workspace = sbar.add("item", {
            ...
            click_script = "/run/current-system/sw/bin/aerospace workspace " .. workspace_index,
    ...
    sbar.exec("/run/current-system/sw/bin/aerospace list-workspaces --focused", function(focused_workspace)
